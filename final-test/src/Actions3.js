...
export const Actions3 = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/php-react/all-users3.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const deleteUser3 = (theID) => {
    ...
    fetch("http://localhost/php-react/delete-user3.php", {
      method: "POST",
      headers: {
  ...
  const updateUser3 = (userData) => {
    fetch("http://localhost/php-react/update-user3.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const insertUser3 = (newUser) => {
    fetch("http://localhost/php-react/insert-user3.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
