...
export const Actions5 = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/php-react/all-users5.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const deleteUser5 = (theID) => {
    ...
    fetch("http://localhost/php-react/delete-user5.php", {
      method: "POST",
      headers: {
  ...
  const updateUser5 = (userData) => {
    fetch("http://localhost/php-react/update-user5.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const insertUser5 = (newUser) => {
    fetch("http://localhost/php-react/insert-user5.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
