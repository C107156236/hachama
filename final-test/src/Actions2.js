...
export const Actions2 = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/php-react/all-users2.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertUser2 = (newUser) => {
    fetch("http://localhost/php-react/insert-user2.php", {
      method: "POST",
      headers: {
  ...
  const deleteUser2 = (theID) => {
    ...
    fetch("http://localhost/php-react/delete-user2.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const updateUser2 = (userData) => {
    fetch("http://localhost/php-react/update-user2.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
